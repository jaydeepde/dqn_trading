...
class DeepQLearner:
    ...
    def __init__(self, input_width, input_height, num_actions,
        ...
        self.imgs_shared = theano.shared(
            np.zeros((batch_size, num_frames + 1, input_width),
        ...
        self.state_shared = theano.shared(
            np.zeros((num_frames, input_width),
                     dtype=theano.config.floatX))
    ...
    def build_network(self, network_type, input_width, input_height,
        ...
        elif network_type == "1d_net":
            return self.build_1D_network(input_width, output_dim, num_frames,
                                         batch_size)
        else:
    ...
    def build_1D_network(self, input_width, output_dim,
                               num_frames, batch_size):
        """
        Build a network consistent with the 2013 NIPS paper.
        """
        ...
        l_in = lasagne.layers.InputLayer(
            shape=(None, num_frames, input_width)
        )
