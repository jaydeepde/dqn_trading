...
def launch(args, defaults, description):
    ...
    if parameters.nn_file is None:
        network = q_network_1d.DeepQLearner(defaults.RESIZED_WIDTH,
    ...
    agent = ale_agent_1d.NeuralAgent(network,
    ...
    experiment = trading_experiment_1d.TradingExperiment(agent,
