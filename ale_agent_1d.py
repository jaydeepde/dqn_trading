...
class NeuralAgent(object):
    ...
    def __init__(self, q_network, epsilon_start, epsilon_min,
        ...
        self.data_set = ale_data_set_1d.DataSet(width=self.image_width,
                                             rng=rng,
                                             max_steps=self.replay_memory_size,
                                             phi_length=self.phi_length)

        # just needs to be big enough to create phi's
        self.test_data_set = ale_data_set_1d.DataSet(width=self.image_width,
                                                  rng=rng,
    ...
    def step(self, reward, observation):
        ...
        if self.testing:
            ...
            action = self._choose_action(self.test_data_set, .05,
                                         observation, np.clip(reward, -10, 10))
    ...
    def end_episode(self, reward, terminal=True, action_trail=[]):
        """
        ...
        self.episode_reward += reward
        self.step_counter += 1
        self.action_trail = action_trail
